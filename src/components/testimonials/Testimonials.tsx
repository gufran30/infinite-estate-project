    ...
    <section className="min-h-screen py-24 overflow-hidden">
      <Container>
        ...
        >
          ...
          {/* Carousel Area */}
          <div className="relative mt-20 w-full max-w-4xl flex items-center justify-center min-h-[500px] md:min-h-[400px]">
            <AnimatePresence initial={false} custom={direction} mode="wait">
              ...
              >
                <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-8 md:p-14 rounded-[2.5rem] shadow-lg flex flex-col items-center">
                  ...
                  <div className="mt-6 text-neutral-700 dark:text-neutral-300 text-sm md:text-base lg:text-lg md:text-xl leading-relaxed italic">
                    {TestimonialsInfo[activeIndex].comment.length > 1 ? (
                      ...
                      <p className="text-center">"{TestimonialsInfo[activeIndex].comment[0]}"</p>
                    )}
                  </div>
